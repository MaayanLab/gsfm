...
class GeneSetDataModule(L.LightningDataModule):
  ...
  def setup(self, stage: str):
    if getattr(self, 'rummageo_train', None) is not None: return
    self.rummageo_train = [
      clean_genes
    ...
    @utils.if_not_exists('data/2025-08-29-rummageo-vocab.pickle')
    def _(filename):
    ...
    self.vocab = utils.Vocab.from_file('data/2025-08-29-rummageo-vocab.pickle')
